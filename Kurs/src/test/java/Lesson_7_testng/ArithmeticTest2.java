...
public class ArithmeticTest2
{
    ...
    @Test
    public void arithmeticTestAddition()
    {
    ...
    @Test
    public void arithmeticTestSubtraction()
    {
    ...
    @Test
    public void arithmeticTestMultiplication()
    {
    ...
    @Test
    public void arithmeticTestDivision()
    {
        assertEquals(10, arithmetic.division(50, 5));
        assertEquals(-15.1875, arithmetic.division(-972, 64));
    }

    @Test
    public void arithmeticTestZero()
    {
